...
//Para não usar Web XML
@WebFilter(urlPatterns = {"/*"}, description = "Filtro verificador de Sessão")
public class LoginFilter implements Filter, Serializable {
    ...
    private boolean isTokenValid(HttpServletRequest request){
        return tokenUtil.isExpirationTimeFromCookieValid(request) && !tokenUtil.getTokemFromCookies(request)
                .isEmpty();
    }
}
